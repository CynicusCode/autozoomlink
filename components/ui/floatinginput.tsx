...
>(({ id, label, placeholderLabel, ...props }, ref) => {
	...
	return (
		<div className="relative">
			...
			{isFocused ? (
				...
				<Label
					htmlFor={id}
					className="absolute start-2 top-1/2 z-10 origin-[0] -translate-y-1/2 scale-100 transform bg-background px-2 text-sm text-gray-500 duration-300 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 dark:bg-background rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4"
				>
					{placeholderLabel}
				</Label>
			)}
