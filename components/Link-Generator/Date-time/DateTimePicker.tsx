...
const FetchDetailsButton: React.FC<FetchDetailsButtonProps> = ({
  ...
  const handleFetchDetails = async () => {
    ...
    try {
      ...
      // Convert the expectedStartDate to a JavaScript Date object
      const startDate = new Date(data.expectedStartDate);
      setValue("dateTimePicker", startDate); // Update the form state with the new date object for DateTimePicker
